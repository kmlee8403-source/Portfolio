...
1. 편집 주소를 엽니다.
2. 문구를 더블클릭해 바로 수정합니다.
3. 목록 항목을 클릭한 뒤 추가, 복제, 이동, 삭제할 수 있습니다.
4. 강의 카드는 편집 패널에서 교육 대상, 기관, 기간, 상세 설명, 검색 키워드도 수정할 수 있습니다.
5. `임시 저장`으로 작업을 보관하거나 `사이트에 게시`로 방문자 화면에 반영합니다.
6. 문제가 있으면 이전 게시 버전을 선택해 복원합니다.
